...
sex_survey_grouped <-
  ...
  mutate(partner_group = case_when(
    partners == 0 & partners_college == 0 ~ "Abstinent since high school",
    partners > 0 & partners_college == 0 ~ "Abstinent since college",
    partners > 0 & partners_college > 0 ~ "Sexually active since high school",
    partners == 0 & partners_college > 0 ~ "Sexually active since college"
  ))
...
sex_survey_grouped %>%
  filter(partner_group == "Abstinent since high school" & !is.na(religious)) %>%
  count(religious)
```
...
One minor error with our survey was that we allowed people to list multiple 
>>>>>>> Stashed changes
